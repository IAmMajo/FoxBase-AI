...
.error {
  width: var(--all-width);
  padding: 10px;
  background-color: color-mix(in srgb, var(--p-inputtext-invalid-border-color), transparent 90%);
...
.button:hover {
  background-color: color-mix(in srgb, var(--light-primary), transparent 60%) !important;
