    ...
    <div class="result-card flex jc-ai-center gap">
        <div class="left-mobile flex flex-column">
            <div class="img-container flex jc-ai-center">
                <img class="default-image" src="./../assets/defaultImage.svg" alt="default image">
            </div>
            <div class="feedback-mobile flex">
                <svg
                    class="arrowUp" :class="{ likedStyle: isLiked }" width="14" height="16" viewBox="0 0 13 15"
                    fill="none" xmlns="http://www.w3.org/2000/svg" @click="onArrowUpClicked">
                    <path
                ...
                <svg
                    class="arrowDown" :class="{ dislikedStyle: isDisliked }" width="14" height="16" viewBox="0 0 13 15"
                    fill="none" xmlns="http://www.w3.org/2000/svg" @click="onArrowDownClicked">
                    <path
        ...
        <div class="info-card flex flex-column gap">
            <p class="title dark-heading no-spacing">{{ product.name }}</p>

            <div class="flex flex-column gapSmall">
                <div class="category-attributes flex">
                    <span class="dot" />
                    <p class="dark-bottomtext no-spacing">Type: <span class="dark-heading">{{ product.category
                            }}</span></p>
                </div>
                ...
                <div class="category-attributes flex">
                    ...
                    <div class="attributes flex gapSmall">
                        <template v-for="(value, key, indexAttributes) in product.attributes" :key="key">
                            <span v-if="indexAttributes!=0" class="vertical-line" />
                            <p class="dark-bottomtext no-spacing">{{ key
                                }}:
            ...
            <div class="use-cases flex gap">
                <p
                    v-for="(useCase, indexUseCase) in product.typicalUseCases" :key="indexUseCase"
                    class="light-highlight no-spacing">{{ useCase }}
                </p>
                <div class="feedback flex">
                    ...
                    <svg
                        class="arrowDown" :class="{ dislikedStyle: isDisliked }" width="14" height="16"
                        viewBox="0 0 13 15" fill="none" xmlns="http://www.w3.org/2000/svg" @click="onArrowDownClicked">
                        <path
                            d="M9.72053 2.57819V7.78926C9.72053 8.31132 10.1437 8.73374 10.6658 8.73374H11.4927C12.3479 8.73374 12.7635 9.77897 12.1418 10.3662L7.67774 14.5827C7.32001 14.9206 6.76288 14.9275 6.39686 14.5986L1.70453 10.3821C1.05987 9.80284 1.46965 8.73374 2.33634 8.73374H3.69493C4.21699 8.73374 4.6402 8.31132 4.6402 7.78926V2.57819C4.6402 0.714822 9.72053 0.714822 9.72053 2.57819Z"
                            stroke="#cbd5e1" stroke-width="1" />
                    </svg>
...
.result-card:hover {
    ...
    background-color: color-mix(in srgb, var(--dark-primary-hover), transparent 92%);
}
...
@media (max-width: 480px) {
    ...
    .line-mobile {
        display: block;
        border-bottom: 1.5px solid color-mix(in srgb, var(--dark-primary), transparent 30%);;
    }
