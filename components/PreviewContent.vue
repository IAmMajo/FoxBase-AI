...
<template>
    <div class="redesign-nav-preview-content-container flex flex-column jc-ai-center">
        <h2 :style="{ color: headingColor }">Das ist der <span :style="{color: primaryColor}">Titel</span></h2>
